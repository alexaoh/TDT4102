...
int main()
{
		...
		do{
			...
			switch(userInput){
				...
				case 7:{
					...
					int n = 5;
					string inp{readInputToString(n, 'a', 'x')};
					cout << "Dette er strengen du lagde: " << inp << endl; 
					break;
					}
				case 8:
					playMastermind();
	...
	//It does not catch an error when typing in a char in userInput
	//Why not?
	//Check out the one example we had in the class (Uke 4)
	catch (...){
