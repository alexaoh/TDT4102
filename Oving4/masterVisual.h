...
constexpr int padY = winH/((guesses+2)*2+1); // velg  x skalering
constexpr int padX = winW/((sizing+1)*2+1); // velg y skalering
constexpr int radCircle = padX/(sizing*2); // velg sirkel radius
